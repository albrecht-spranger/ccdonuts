...
INSERT INTO `products` VALUES (1,'CCドーナツ 当店オリジナル（5個入り）',1500,'当店のオリジナル商品、CCドーナツは、サクサクの食感が特徴のプレーンタイプのドーナツです。素材にこだわり、丁寧に揚げた生地は軽やかでサクッとした食感が楽しめます。一口食べれば、口の中に広がる甘くて香ばしい香りと、口どけの良い食感が感じられます。','original.jpg',0),(2,'チョコレートデライト（5個入り）',1600,'チョコレートデライトは、濃厚なカカオの風味となめらかな口どけが特徴です。ひとつひとつ丁寧に仕上げたひと口サイズのチョコレートは、口に入れた瞬間に広がる芳醇な香りと上品な甘さをお楽しみいただけます。','chocolateDelight.jpg',0),(3,'キャラメルクリーム（5個入り）',1600,'キャラメルクリームは、やさしい甘さのキャラメルと、とろけるようなクリームの味わいが楽しめるスイーツです。なめらかな口どけと香ばしい風味が広がり、ひと口ごとに心まで満たされる上品な味わいに仕上げました。','caramelCream.jpg',0),(4,'プレーンクラシック（5個入り）',1500,'プレーンクラシック（5個入り）は、シンプルだからこそ素材の良さと職人の技が際立つスイーツです。香ばしく焼き上げた生地はふんわり軽やかで、ひと口食べればやさしい甘さと素朴な風味が広がります。毎日でも食べたくなる、当店定番のクラシックな一品です。','plainClassic.jpg',0),(5,'サマーシトラス（5個入り）',1600,'サマーシトラス（5個入り）は、爽やかな香りと軽やかな甘さが楽しめる限定スイーツです。ふんわり焼き上げた生地にシトラスの風味を閉じ込め、ひと口ごとに広がる清涼感は暑い季節にぴったり。紅茶やアイスコーヒーとの相性も良く、贈り物にもおすすめの爽快な一品です。','summerCitrus.jpg',1),(6,'ストロベリークラッシュ（5個入り）',1800,'ストロベリークラッシュ（5個入り）は、甘酸っぱい苺の香りとジューシーな果実感が楽しめる華やかなスイーツです。ふんわり焼き上げた生地にストロベリーの風味をぎゅっと閉じ込め、ひと口ごとに広がるフレッシュな味わいが特徴の一品です。','strawberryCrush.jpg',0),(7,'フルーツドーナツセット（12個入り）',3500,'新鮮で豊かなフルーツをたっぷりと使用した贅沢な12個入りセットです。このセットには、季節の最高のフルーツを厳選し、ドーナツに取り入れました。口に入れた瞬間にフルーツの風味と生地のハーモニーが広がります。色鮮やかな見た目も魅力の一つです。','fruitDonutAssortment.jpg',0),(8,'フルーツドーナツセット（14個入り）',4000,'フルーツドーナツセット（14個入り）は、爽やかな柑橘や甘酸っぱい苺など、多彩なフルーツフレーバーをたっぷり楽しめるボリューム満点のセットです。人数の多い集まりや特別なシーンにもぴったり。華やかで満足感のあるひと箱が、食卓をより楽しく彩ります。','fruitDonutSet.jpg',0),(9,'ベストセレクションボックス（4個入り）',1200,'当店おすすめの人気フレーバーを詰め合わせたベストセレクションボックス（4個入り）は、少量ながらこだわりの味を堪能できる特別なセットです。丁寧に仕上げたドーナツは、贈り物や自分へのご褒美にもぴったり。コンパクトでも満足感のある自慢のセレクションです。','bestSelectionBox.jpg',0),(10,'チョコクラッシュボックス（7個入り）',2400,'濃厚なチョコレートの風味をたっぷり楽しめるチョコクラッシュボックス（7個入り）は、食べ応えのある満足セットです。外はサクッと、中はふんわり仕上げたドーナツは、家族や友人とのシェアやギフトにも最適。チョコ好きに贈る特別なひと箱です。','chocolateCrushBox.jpg',0),(11,'クリームボックス（4個入り）',1400,'なめらかなクリームの甘さが楽しめるクリームボックス（4個入り）は、気軽に味わえる少量セットです。ふんわり生地と濃厚クリームの絶妙なバランスは、ティータイムやちょっとしたギフトにもぴったり。コンパクトでも満足感のある一品です。','creamBox4pcs.jpg',0),(12,'クリームボックス（9個入り）',2800,'クリームボックス（9個入り）は、なめらかなクリームの濃厚な味わいをたっぷり楽しめるボリュームセットです。ふんわり軽い生地とコク深いクリームが、ひと口ごとに広がる贅沢なひとときを演出します。大切な方へのギフトにも喜ばれる存在感のあるひと箱です。','creamBox9pcs.jpg',0);
...
-- Dump completed on 2025-09-26 15:29:53
